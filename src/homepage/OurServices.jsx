...
function OurServices() {
  return (
    <section className='relative bg-[url("/images/wood.jpg")] bg-cover bg-center bg-fixed py-10 px-5 text-white'>
    <div className="absolute inset-0 bg-black/80 z-0"></div>
      <h1 className="text-center text-white font-normal relative">Our Services</h1>
      <div className="three-image flex gap-28 container relative mt-10 center-all">
        <div className="card flex flex-col gap-5 center-all max-w-[300px]">
          <img className='rounded-full' src="/images/image-11.webp" alt="" />
        ...
        <div className="card flex flex-col gap-5 center-all max-w-[300px]">
          <img className='rounded-full' src="/images/image-12.webp" alt="" />
          <div className="texts text-justify">
        ...
        <div className="card flex flex-col gap-5 center-all max-w-[300px]">
          <img className='rounded-full' src="/images/image-15.webp" alt="" />
          <div className="texts text-justify">
